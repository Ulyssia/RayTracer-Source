The code renders a 3D scene with 2 light sources and 3 transparent spheres within a box. 
...
4. Special case reminder: 
   To get decent result for the partialcube example, I commented the shadow logic part in func.cpp(line 318~353)